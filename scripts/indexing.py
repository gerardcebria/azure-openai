...
from azure.search.documents.indexes.models import SearchableField, SearchFieldDataType, SimpleField, SearchField
...
if __name__ == '__main__':
    ...
    parser.add_argument('--documents-path', type=str, default='data/transformers_docs_full')
